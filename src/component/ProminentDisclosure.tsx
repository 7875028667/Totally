        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.content}>
                ...
                <Text style={styles.text}>
                    For the purpose of ensuring optimal functionality of our services, particularly in map  and attendance tracking, we require the following permissions from YOU:
                </Text>
                <Text style={styles.subTitle}>Location</Text>
                <Text style={styles.text}>
                    Map Screen - When a driver is assigned, our app collects and transmits the location data from the start location to the end location. This data collection may occur even when the app is closed. This is necessary for tracking the driver's route and ensuring accurate record-keeping.
                </Text>
                <Text style={styles.text}>
